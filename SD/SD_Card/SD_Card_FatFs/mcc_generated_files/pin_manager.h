...
#if defined _18F45K20 || defined _18F45K22
...
#elif  _18F26K22						/* RC7 is P3.1  SD-card pin 1 Card Select */
  #define SD_CS_TRIS               TRISC7
  #define SD_CS_LAT                LATC7
  #define SD_CS_PORT               PORTCbits.RC7
  #define SD_CS_SetHigh()	  do { LATC7 = 1; } while(0)
  #define SD_CS_SetLow()	  do { LATC7 = 0; } while(0)
  #define SD_CS_Toggle()	  do { LATC7 = ~LATC7; } while(0)
  #define SD_CS_GetValue()         PORTCbits.RC7
  #define SD_CS_SetDigitalInput()	do { TRISC7 = 1; } while(0)
  #define SD_CS_SetDigitalOutput()	do { TRISC7 = 0; } while(0)
  #define SD_CS_SetAnalogMode()		do { ANSC7 = 1; } while(0)
  #define SD_CS_SetDigitalMode()	do { ANSC7 = 0; } while(0)
#endif
// get/set SCK1 aliases						/* SCK1 P3.5 SD Pin 5 */
...
// get/set SDI1 aliases					SDI1 P3.4  MISO  SD-card pin 7 SDO
...
// get/set SDO1 aliases					SPI Output Pin 16 Jumper to P3.6 MOSI SD-card DI Pin 2
